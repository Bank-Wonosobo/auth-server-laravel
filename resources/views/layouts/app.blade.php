...
<head>
  ...
  <!-- PWA  -->
    ...
    <link rel="apple-touch-icon" href="{{ asset('bg-01.png') }}">
  ...
  <!-- Favicons -->
  <link href="{{ asset('bg-01.png') }}" rel="icon">
  <link href="{{ asset('bg-01.png') }}" rel="apple-touch-icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/" class="logo d-flex align-items-center">
        <img src="{{ asset('bg-01.png') }}" alt="">
        <span class="d-none d-lg-block">Apps</span>
      </a>
