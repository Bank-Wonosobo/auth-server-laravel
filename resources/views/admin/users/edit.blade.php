...
<div class="row d-flex my-4">
    <div class="col-md-8">
        <a href="{{ route('users.index') }}" class="btn btn-success mb-2">Kembali</a>
        <div class="d-flex my-3 ">
            ...
            <form onSubmit="if(!confirm('Yakin ingin generate password ?')){return false;}" method="POST" action="{{ route('users.generate-password', $user->id) }}">
                @csrf
